...
function twentytwelve_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Last bar left Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-5',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Last bar right Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-6',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'First Middle Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-8',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Second Middle Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-9',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Third Middle Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-10',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Awards Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-11',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Contact Form Right Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-12',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Top Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-13',
			'description'   => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
